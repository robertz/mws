component {
    ...
    private string function generateSignedUrl (string verb = "GET", string host = "", string uri = "/", required struct params) {
        var props = {};
        ...
        props['signature'] = encodeForURL(toBase64(binaryDecode(hmac(props.toEncode, variables.secretKey, "HMACSHA256", "UTF-8"), "hex")));
